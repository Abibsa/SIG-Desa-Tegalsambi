...
<head>
    ...
    <title>Confirm Password - WebGIS Tegalsambi</title>
    ...
    <style>
        * {
        ...
        .input-cyber:focus {
            border-color: #EF4444;
            box-shadow: 0 0 15px rgba(239, 68, 68, 0.4), inset 0 0 10px rgba(239, 68, 68, 0.1);
        }
                ...
                <div class="p-6">
                    <div class="text-center mb-8">
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <p class="text-xs text-gray-500 uppercase tracking-[0.3em]">Secure Area</p>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
                        ...
                        <div class="relative">
                            <label for="password"
                                class="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">Password</label>
                            <input id="password" type="password" name="password" required
                                autocomplete="current-password" placeholder="••••••••••"
                                class="input-cyber w-full px-4 py-2.5 bg-black/80 border border-gray-700/50 rounded-lg text-gray-100 text-sm placeholder-gray-500 focus:outline-none transition-all duration-300" />
                            <x-input-error :messages="$errors->get('password')" class="mt-1.5 text-xs text-red-500" />
                        </div>

                        <button type="submit"
                            class="btn-cyber w-full py-3.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold text-sm uppercase tracking-widest rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-black mt-6">
